          ...
          >
            <ul className="login-modal__list">
              <li className="login-modal__item">
                ...
                <input className="login-modal__input" type="text" name="login" id="login"/>
              </li>
              <li className="login-modal__item login-modal__item--password">
                ...
                <input
                  ...
                  id='password'
                />
                <button className="login-modal__show" type="button" onClick={showPasswordBtnClickHandler}>
            ...
            <button className="login-modal__btn">Войти</button>
          </form>
        </div>
      </div>
    </div>
