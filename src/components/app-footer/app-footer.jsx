...
function AppFooter() {
  return (
    <>
      <ul className="app__list app-footer">
        <li className="app-footer__item">
          <Logo/>
          <p className="app__text app-footer__license-text">
        ...
        <li className="app-footer__item">
          <ul className="app__list app-footer__services-list">
            <li className="app-footer__services-item">
              <a className="app__link app-footer__services-link" href="#">Услуги</a>
            </li>
            <li className="app-footer__services-item">
              <a className="app__link app-footer__services-link" href="#">Рассчитать кредит</a>
            </li>
            <li className="app-footer__services-item">
              <a className="app__link app-footer__services-link" href="#">Контакты</a>
            </li>
            <li className="app-footer__services-item">
              <a className="app__link app-footer__services-link" href="#">Задать вопрос</a>
            </li>
          </ul>
        </li>
        <li className="app-footer__item app-footer__item--contact">
          ...
          <p className="app__text app-footer__message-text">Бесплатно для абонентов<br/> МТС, Билайн, Мегафон, Теле2</p>
        </li>
        <li className="app-footer__item app-footer__item--contact">
          <a className="app__link app-footer__contact-link app-footer__contact-link--phone" href="tel:+78001112233">
            <svg className="app-footer__contact-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <p className="app__text app-footer__message-text app-footer__message-text--phone">Бесплатный для всех городов России</p>
        </li>
        <li className="app-footer__item">
          <SocialList/>
        </li>
      ...
      <div className="app-footer__mobile">
        <div className="app-footer__mobile-container app-footer__mobile-container--left">
          <ul className="app__list">
            ...
            <li className="app-footer__item app-footer__item--license-text">
              <p className="app__text app-footer__license-text">
                150015, г. Москва, ул. Московская, д. 32<br/>
                Генеральная лицензия Банка России №1050<br/>
                Ⓒ Лига Банк, 2019
